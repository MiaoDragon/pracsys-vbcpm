...
def grasp_pose_generation(obj_id, obj, robot, workspace, occlusion, occlusion_label, occupied_label):
    """
    ...
    selected_suction_pts = np.random.choice(len(transformed_suction_pts), 10)
